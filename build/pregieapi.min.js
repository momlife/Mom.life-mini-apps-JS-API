...
PREGIEAPI.load("device","utils").module("api",function(c){var a=function(){};a.prototype.deviceInterface=function(){return this};a.prototype.getCurrentUserId=function(){throw Error("MOCK INTERFACE - getCurrentUserId()");};a.prototype.showToast=function(){throw Error("MOCK INTERFACE - showToast()");};a.prototype.getAuthToken=function(){return"test-token"};a.prototype.uploadImage=function(a){var c=0,d=setInterval(function(){window[a.progress]({status:200,progress:++c});10==c&&(clearInterval(d),window[a.done]({status:200,
url:"https://www.google.ru/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png"}))},1E3)};var d=function(){this.deviceInterface=function(){return c.device.os.android()?window.Android:c.device.os.ios()?window.iOS:(new a).deviceInterface()}};d.prototype=Object.create(a.prototype);d.prototype.constructor=d;d.prototype.getCurrentUserId=function(){return this.deviceInterface().getCurrentUserId()};d.prototype.showToast=function(a){this.deviceInterface().showToast(a)};d.prototype.getAuthToken=function(){return this.deviceInterface().getAuthToken()};
d.prototype.uploadImage=function(a){this.deviceInterface().uploadImage({progress:c.utils.createGlobalCallback(a.progress),done:c.utils.createGlobalCallback(a.done)})};return this.publicateAPI("API",new d)});
