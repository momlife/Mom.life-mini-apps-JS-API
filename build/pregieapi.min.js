...
d.prototype.getAuthToken=function(){return this.deviceInterface().getAuthToken()};d.prototype.uploadImage=function(a){var d=c.utils.createGlobalCallback(a.progress),f=c.utils.createGlobalCallback(function(l){[d,f].forEach(function(a){c.utils.removeGlobalCallback(a)});a.done&&a.done(l)});this.deviceInterface().uploadImage(JSON.stringify({progress:d,done:f}))};return this.publicateAPI("API",new d)});
