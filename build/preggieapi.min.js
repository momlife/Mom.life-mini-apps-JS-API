/*! 
 * momlife-extensions-js-api v1.3.1
 * 
 * Author: Alexander Usolcev <alexander.usolcev@gmail.com>
 * Date: 2017-01-02 12:05:42
 * 
 */
!function(a) {
    "use strict";
    ...
    if (!a.fetch) {
        ...
        if (r.arrayBuffer)var s = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"], t = function(a) {
...
}("undefined" != typeof self ? self : this), (Modules = window.Modules || {}).name = Modules.name || "Modules", Modules && Modules.load || (Modules = window[Modules.name] = function(a) {
    var b = {}, c = {}, d = {}, e = [], f = {}, g = {}, h = {forced_loading: !1}, i = function() {
        window.console && console.warn.apply(console, arguments)
    }, j = function(a) {
        var b = a || [], c = function(a) {
            for (var c = 0; c < b.length; c++)a(b[c], c, b);
            return b
        };
        return {
            forEach: function(a) {
                ...
                var d = [];
                return c(function() {
                    d.push(a.apply(b, arguments))
                }), d
            }, filter: function(a) {
                var d = [];
                return c(function() {
                    a.apply(b, arguments) && d.push(arguments[0])
                }), d
            }
        }
    }, k = function(a, b) {
        ...
        b[c] || (b[c] = d.call(window[a], e || void 0)), m()
    }, m = function() {
        var a = [];
        e = j(e).filter(function(c) {
            return j(c[1]).filter(function(a) {
                    return !b[a]
                }).length > 0 || function() {
                    a.push(function(a, b) {
                        return function() {
        ...
        var c = {};
        return j(a).forEach(function(a) {
            var d = c, e = a.split("."), f = e.pop();
            j(e).forEach(function(a) {
                d = d[a] || (d[a] = {})
            }), d[f] = b[a]
        }), c
    }, o = function(b) {
        return {
            run: function(c) {
                ...
                g[a] || (g[a] = b), j(b).forEach(function(b) {
                    g[b] && g[b].indexOf(a) != -1 && i('Cross modular relation between modules "%s" and "%s". Modules not loaded.', a, b)
                }), k(function(b) {
                    l(a, c, b)
                }, b)
            }
        ...
        for (var b = document.getElementsByTagName("script"), c = 0; c < b.length; c++) {
            ...
            if (d.indexOf(a) != -1)return d.substr(0, d.indexOf(a))
        }
        return ""
    }, q = function(a) {
        for (var b in d)if (0 == a.indexOf(b))return d[b];
        return function() {
            for (var b = a.length + 1; --b > 0;) {
                var d = a.substring(0, b);
                if ("undefined" != typeof c[d])return c[d] + "/" + a.substr(d.length).split(".").join("/") + ".js"
            }
            return p("/modules.") + "/plugins/" + a.split(".").join("/") + ".js"
        }().replace(/([A-Z])/g, function(a) {
            return "-" + a.toLowerCase()
        }).replace(/\/-/g, "/")
    }, r = function() {
        return function(a) {
            if (!f[a] || h.forced_loading) {
                var b = document.createElement("script");
                b.setAttribute("src", a + (h.forced_loading ? "?" + Math.random() : "")), b.setAttribute("type", "text/javascript"), document.getElementsByTagName("head")[0].appendChild(b), f[a] = !0
            } else m()
        }
    }(), s = function(a) {
        var c = function(a) {
            var b = a.match(/^(.*)\((.*)\)$/) || [];
            return 3 == b.length ? j(b[2].split("|")).map(function(a) {
                    return b[1] + a
                }) : [a]
        }, d = [];
        return j(a).forEach(function(a) {
            j(c(a)).forEach(function(a) {
                d.push(a), b[a] || setTimeout(function() {
                    b[a] || r(q(a))
                }, 50)
            })
        }), d
    };
    c["modules."] = p("/modules.") + "/plugins";
    var t = function(a, b) {
    ...
    return {
        load: function() {
            return o(s(Array.prototype.slice.call(arguments)))
        }, addPath: function(a, b) {
            c[a] = b
        }, addPackage: function(a, b) {
            d[a] = b
        }, publicateAPI: function(b, c) {
            return "undefined" == typeof window[a][b] && (window[a][b] = c), c
        }, self: function(a) {
            f[a] = !0
        }, module: function(a, b) {
            l(a, b)
            ...
            return t(h, a), this
        }, name: window[a].name, $debugger: {modules: b, paths: c, packages: d, hooks: e, dependencies: g}
    }
}("Modules")), Modules.load("device", "utils", "random").module("api", function(a) {
    function b(a) {
        console.warn(a)
    }

    window.PREGGIEAPI = Modules;
    var c = "https://js-api.ext.mom.life", d = function() {
    };
    d.prototype.deviceInterface = function() {
        return this
    }, d.prototype.getCurrentUserId = function() {
        return "123456789"
    }, d.prototype.showToast = function(a) {
        alert(a)
    }, d.prototype.getAuthToken = function(a) {
        a = JSON.parse(a), fetch(c + "/auth/preggie/bind", {
            method: "POST",
            headers: {"Content-Type": "application/json"},
            body: JSON.stringify({preggie_id: "123456789", login: "some-login"})
        }).then(function(a) {
            return a.json()
        }).then(function(b) {
            window[a.success]({token: b["auth-token"]})
        }).catch(function(b) {
            window[a.error]({status: 101, statusText: "getAuthToken error; " + JSON.stringify(b)})
        })
    }, d.prototype.upload = function(a, b) {
        b = JSON.parse(b);
        var c = 0, d = (Math.random() >= .5 ? 101 : 100, setInterval(function() {
            window[b.progress]({progress: c += 10}), 100 == c && (clearInterval(d), window[b.success]({name: "2015:12:23:0820a982-8837-4f26-b8e0-cea32c121c6c.jpg"}))
        }, 500));
        return window[b.preview](""), d
    }, d.prototype.cancelUpload = function(a) {
        clearInterval(a)
    }, d.prototype.makePayment = function(b, c) {
        c = JSON.parse(c), setTimeout(function() {
            window[c.success]({transaction_id: a.random.randomNumber()})
        }, 1e3)
    }, d.prototype.getAppId = function() {
        return "123456789"
    }, d.prototype.canExit = function(a) {
    }, d.prototype.setTitle = function(a) {
        document.title = a
    }, d.prototype.isDevice = function() {
        return !(!window.Android && !window.iOS)
    }, d.prototype.version = "1.3.1";
    var e = function() {
        this.deviceInterface = function() {
            return a.device.os.android() ? window.Android : a.device.os.ios() ? window.iOS : (new d).deviceInterface()
        }, Object.defineProperties(this, {_token: {writable: !0, value: null}, canExitState: {writable: !0, value: !0}})
    };
    return e.prototype = Object.create(d.prototype), e.prototype.constructor = e, e.prototype.getCurrentUserId = function() {
        return this.deviceInterface().getCurrentUserId()
    }, e.prototype.showToast = function(a) {
        this.deviceInterface().showToast(a)
    }, e.prototype.getAuthToken = function(b) {
        function c(c) {
            [f, g].forEach(function(b) {
                a.utils.removeGlobalCallback(b)
            }), b.success && b.success(e._token = c.token, c)
        }
        ...
        if (!b)return this._token;
        var e = this, f = a.utils.createGlobalCallback(c), g = a.utils.createGlobalCallback(d);
        return this.deviceInterface().getAuthToken(JSON.stringify({success: f, error: g}))
    }, e.prototype.upload = function(b, c) {
        function d(b) {
            [f, g, h, i].forEach(function(b) {
                a.utils.removeGlobalCallback(b)
        ...
        var f = a.utils.createGlobalCallback(c.preview), g = a.utils.createGlobalCallback(c.progress), h = a.utils.createGlobalCallback(d), i = a.utils.createGlobalCallback(e);
        return this.deviceInterface().upload(b, JSON.stringify({preview: f, progress: g, success: h, error: i}))
    }, e.prototype.cancelUpload = function(a) {
        this.deviceInterface().cancelUpload(a)
    }, e.prototype.makePayment = function(b, c) {
        function d(b) {
            [f, g].forEach(function(b) {
                a.utils.removeGlobalCallback(b)
            }), c.success && c.success(b)
        ...
        var f = a.utils.createGlobalCallback(d), g = a.utils.createGlobalCallback(e);
        this.deviceInterface().makePayment(b, JSON.stringify({success: f, error: g}))
    }, e.prototype.getAppId = function() {
        return this.deviceInterface().getAppId()
    }, e.prototype.canExit = function(a) {
        return arguments.length > 0 && (this.canExitState = !!a), this.deviceInterface().canExit(this.canExitState), this.canExitState
    }, e.prototype.setTitle = function(a) {
        try {
            a && this.deviceInterface().setTitle(a)
        } catch (a) {
            b(a)
        }
        return a
    }, this.publicateAPI("API", new e)
}), Modules.module("date", function() {
    var a = {};
    return a.absolute = function() {
        var a = new Date(0);
        return {
            day: function(b) {
                return a.setDate(b), this
            }, month: function(b) {
                return a.setMonth(b - 1), this
            }, year: function(b) {
                return a.setFullYear(b), this
            }, getTime: function() {
                return a.getTime()
            }, getUTC: function() {
    ...
    }, a.unixtime = function(a) {
        return ~~((a || new Date).getTime() / 1e3)
    }, a.toLocaleString = function(b, c, d) {
        var e = new Date(1e3 * (b || a.unixtime()));
        return e.toLocaleString(c || "ru", d)
    }, a.H_M = function(a) {
        var b = new Date(1e3 * a), c = b.getHours() < 10 ? "0" + b.getHours() : b.getHours(), d = b.getMinutes() < 10 ? "0" + b.getMinutes() : b.getMinutes();
        return c + ":" + d
    }, this.publicateAPI("date", a)
}), Modules.module("device", function() {
    var a = navigator.userAgent, b = null, c = (a.match(/Web[kK]it[\/]{0,1}([\d.]+)/), a.match(/(Android);?[\s\/]+([\d.]+)?/)), d = a.match(/(iPad).*OS\s([\d_]+)/), e = a.match(/(iPod)(.*OS\s([\d_]+))?/), f = !d && a.match(/(iPhone\sOS)\s([\d_]+)/), g = {
        platform: {name: (navigator.platform.match(/mac|win|linux/i) || ["unknown"])[0].toLowerCase()},
        webview: function() {
            return "undefined" != typeof window.Android || "undefined" != typeof window.iOS
        },
        os: {
            version: function() {
                return b
                ...
                return d && (b = d[2].replace(/_/g, ".")), d
            }, ipod: function() {
                return e && (b = e[3] ? e[3].replace(/_/g, ".") : null), e
            }, iphone: function() {
                return f && !e && (b = f[2].replace(/_/g, ".")), f
            }
        }
    };
    return this.publicateAPI("device", g)
}), Modules.module("random", function() {
    var a = function(a, b) {
        for (var c = b || "ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz_0123456789", d = a || 16, e = [], f = 0, g = c.length - 1; f < d; f++)e.push(c.charAt(Math.round(Math.random() * g)));
        return e.join("")
    }, b = function(b) {
        return "_" + a(b)
    }, c = function(a) {
        return parseInt(Math.random().toString().substr(2, a || 10))
    }, d = {randomString: a, randomId: b, randomNumber: c};
    return this.publicateAPI("random", d)
}), Modules.load("random").module("utils", function(a) {
    var b = window, c = {
        createGlobalCallback: function(c) {
            for (var d = function(a) {
                return b[a] = function() {
                    c.call(b, arguments[0])
                }, a
            }, e = 0; e++ < 10;) {
                var f = "_" + a.random.randomString();
                if ("undefined" == typeof b[f])return d(f)
            }
            throw new Error("createGlobalCallback: cannot create unique name for callback")
        }, removeGlobalCallback: function(a) {
            try {
                b[a] = void 0, delete b[a]
            } catch (a) {
            }
        }, plural: function(a, b, c) {
            var d = [2, 0, 1, 1, 1, 2];
            return (c ? a + " " : "") + b[a % 100 > 4 && a % 100 < 20 ? 2 : d[a % 10 < 5 ? a % 10 : 5]]
        }
    };
    return this.publicateAPI("utils", c)
});