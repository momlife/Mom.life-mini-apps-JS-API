/*! PREGGIE_EXTENSIONS_JS_API | 2016-05-03 */
...
return f};b.prototype.cancelUpload=function(a){clearInterval(a)};b.prototype.makePayment=function(a,b){b=JSON.parse(b);setTimeout(function(){window[b.success]({transaction_id:c.random.randomNumber()})},1E3)};b.prototype.getAppId=function(){return"123456789"};b.prototype.canExit=function(a){};b.prototype.isDevice=function(){return!(!window.Android&&!window.iOS)};var a=function(){this.deviceInterface=function(){return c.device.os.android()?window.Android:c.device.os.ios()?window.iOS:(new b).deviceInterface()};
Object.defineProperties(this,{_token:{writable:!0,value:null},_canExit:{writable:!0,value:!0}})};a.prototype=Object.create(b.prototype);a.prototype.constructor=a;a.prototype.getCurrentUserId=function(){return this.deviceInterface().getCurrentUserId()};a.prototype.showToast=function(a){this.deviceInterface().showToast(a)};a.prototype.getAuthToken=function(a){if(!a)return this._token;var b=this,e=c.utils.createGlobalCallback(function(h){[e,f].forEach(function(a){c.utils.removeGlobalCallback(a)});a.success&&
a.success(b._token=h.token,h)}),f=c.utils.createGlobalCallback(function(b){[e,f].forEach(function(a){c.utils.removeGlobalCallback(a)});a.error&&a.error(b)});return this.deviceInterface().getAuthToken(JSON.stringify({success:e,error:f}))};a.prototype.upload=function(a,b){var e=c.utils.createGlobalCallback(b.preview),f=c.utils.createGlobalCallback(b.progress),h=c.utils.createGlobalCallback(function(a){[e,f,h,m].forEach(function(a){c.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),m=c.utils.createGlobalCallback(function(a){[e,
f,h,m].forEach(function(a){c.utils.removeGlobalCallback(a)});b.error&&b.error(a)});return this.deviceInterface().upload(a,JSON.stringify({preview:e,progress:f,success:h,error:m}))};a.prototype.cancelUpload=function(a){this.deviceInterface().cancelUpload(a)};a.prototype.makePayment=function(a,b){var e=c.utils.createGlobalCallback(function(a){[e,f].forEach(function(a){c.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),f=c.utils.createGlobalCallback(function(a){[e,f].forEach(function(a){c.utils.removeGlobalCallback(a)});
b.error&&b.error(a)});this.deviceInterface().makePayment(a,JSON.stringify({success:e,error:f}))};a.prototype.getAppId=function(){return this.deviceInterface().getAppId()};a.prototype.canExit=function(a){0<arguments.length&&(this._canExit=!!a);this.deviceInterface().canExit(this._canExit);return this._canExit};return this.publicateAPI("API",new a)});
