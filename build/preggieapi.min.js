...
return e}}},n=function(b,a){e.push([b,a]);m()},m=function(){var a=[];e=k(e).filter(function(c){return 0<k(c[1]).filter(function(a){return!b[a]}).length||function(){a.push(function(a,b){return function(){a(b)}}(c[0],p(c[1])))}()});k(a).forEach(function(a){a()})},p=function(a){var c={};k(a).forEach(function(a){var e=c,d=a.split("."),f=d.pop();k(d).forEach(function(a){e=e[a]||(e[a]={})});e[f]=b[a]});return c},q=function(a){return{run:function(b){n(function(a){b.call(window[d],a)},a)},module:function(c,
e){g[c]||(g[c]=a);a.forEach(function(a){g[a]&&-1!=g[a].indexOf(c)&&l('Cross modular relation between modules "%s" and "%s". Modules not loaded.',c,a)});n(function(a){b[c]||(b[c]=e.call(window[d],a||void 0));m()},a)}}};(function(){return function(a){if(!f[a]||h.forced_loading){var c=document.createElement("script");c.setAttribute("src",a+(h.forced_loading?"?"+Math.random():""));c.setAttribute("type","text/javascript");document.getElementsByTagName("head")[0].appendChild(c);f[a]=!0}else m()}})();var r=
function(a){var c=function(a){var c=a.match(/^(.*)\((.*)\)$/)||[];return 3==c.length?k(c[2].split("|")).map(function(a){return c[1]+a}):[a]},b=[];k(a).forEach(function(a){k(c(a)).forEach(function(a){b.push(a)})});return b};a["modules."]=function(a){for(var c=document.getElementsByTagName("script"),b=0;b<c.length;b++){var e=c[b].getAttribute("src")||"";if(-1!=e.indexOf(a))return e.substr(0,e.indexOf(a))}return""}("/modules.")+"/plugins";return{load:function(){return q(r(Array.prototype.slice.call(arguments)))},
addPath:function(c,b){a[c]=b},addPackage:function(a,b){c[a]=b},publicateAPI:function(a,c){"undefined"==typeof window[d][a]&&(window[d][a]=c);return c},self:function(a){f[a]=!0},module:function(a,c){b[a]||(b[a]=c.call(window[d],void 0));m()},setup:function(a){for(var c in a)h[c]=a[c];return this},name:window[d].name,$debugger:{modules:b,paths:a,packages:c,hooks:e,dependencies:g}}}("Modules"));
