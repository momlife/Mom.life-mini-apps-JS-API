/*! PREGGIE_EXTENSIONS_JS_API | 2016-03-29 */
...
e){g[c]||(g[c]=a);k(a).forEach(function(a){g[a]&&-1!=g[a].indexOf(c)&&l('Cross modular relation between modules "%s" and "%s". Modules not loaded.',c,a)});n(function(a){b[c]||(b[c]=e.call(window[d],a||void 0));m()},a)}}},p=function(a){for(var c=document.getElementsByTagName("script"),b=0;b<c.length;b++){var e=c[b].getAttribute("src")||"";if(-1!=e.indexOf(a))return e.substr(0,e.indexOf(a))}return""},t=function(b){for(var e in c)if(0==b.indexOf(e))return c[e];return function(){for(var c=b.length+1;0<
--c;){var e=b.substring(0,c);if("undefined"!=typeof a[e])return a[e]+"/"+b.substr(e.length).split(".").join("/")+".js"}return p("/modules.")+"/plugins/"+b.split(".").join("/")+".js"}().replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}).replace(/\/-/g,"/")},u=function(){return function(a){if(!f[a]||h.forced_loading){var b=document.createElement("script");b.setAttribute("src",a+(h.forced_loading?"?"+Math.random():""));b.setAttribute("type","text/javascript");document.getElementsByTagName("head")[0].appendChild(b);
f[a]=!0}else m()}}(),v=function(a){var c=function(a){var b=a.match(/^(.*)\((.*)\)$/)||[];return 3==b.length?k(b[2].split("|")).map(function(a){return b[1]+a}):[a]},e=[];k(a).forEach(function(a){k(c(a)).forEach(function(a){e.push(a);b[a]||setTimeout(function(){b[a]||u(t(a))},50)})});return e};a["modules."]=p("/modules.")+"/plugins";return{load:function(){return s(v(Array.prototype.slice.call(arguments)))},addPath:function(b,c){a[b]=c},addPackage:function(a,b){c[a]=b},publicateAPI:function(a,b){"undefined"==
typeof window[d][a]&&(window[d][a]=b);return b},self:function(a){f[a]=!0},module:function(a,c){b[a]||(b[a]=c.call(window[d],void 0));m()},setup:function(a){for(var b in a)h[b]=a[b];return this},name:window[d].name,$debugger:{modules:b,paths:a,packages:c,hooks:e,dependencies:g}}}("Modules"));
Modules.load("device","utils","random").module("api",function(d){window.PREGGIEAPI=Modules;var b=function(){};b.prototype.deviceInterface=function(){return this};b.prototype.getCurrentUserId=function(){return"123456789"};b.prototype.showToast=function(a){alert(a)};b.prototype.getAuthToken=function(a){a=JSON.parse(a);fetch("http://extension-consultation.preggie.testbb.ru/auth/ext",{method:"POST",body:JSON.stringify({username:"admin",password:"1"}),headers:{"Content-Type":"application/json"}}).then(function(a){return a.json()}).then(function(b){window[a.success]({token:"JWT "+
...
return g};b.prototype.cancelUpload=function(a){clearInterval(a)};b.prototype.makePayment=function(a,b){b=JSON.parse(b);setTimeout(function(){window[b.success]({transaction_id:d.random.randomNumber()})},1E3)};b.prototype.getAppId=function(){return"123456789"};b.prototype.canExit=function(a){};var a=function(){this.deviceInterface=function(){return d.device.os.android()?window.Android:d.device.os.ios()?window.iOS:(new b).deviceInterface()};Object.defineProperties(this,{_token:{writable:!0,value:null},
...
Modules.module("date",function(){var d={absolute:function(){var b=new Date(0);return{day:function(a){return b.setDate(a),this},month:function(a){return b.setMonth(a-1),this},year:function(a){return b.setFullYear(a),this},getTime:function(){return b.getTime()},getUTC:function(){return b.toUTCString()}}},unixtime:function(b){return~~((b||new Date).getTime()/1E3)},toLocaleString:function(b,a,c){return(new Date(1E3*(b||d.unixtime()))).toLocaleString(a||"ru",c)},H_M:function(b){var a=new Date(1E3*b);b=
10>a.getHours()?"0"+a.getHours():a.getHours();a=10>a.getMinutes()?"0"+a.getMinutes():a.getMinutes();return b+":"+a}};return this.publicateAPI("date",d)});
Modules.module("device",function(){var d=navigator.userAgent,b=null;d.match(/Web[kK]it[\/]{0,1}([\d.]+)/);var a=d.match(/(Android);?[\s\/]+([\d.]+)?/),c=d.match(/(iPad).*OS\s([\d_]+)/),e=d.match(/(iPod)(.*OS\s([\d_]+))?/),f=!c&&d.match(/(iPhone\sOS)\s([\d_]+)/),d={platform:{name:(navigator.platform.match(/mac|win|linux/i)||["unknown"])[0].toLowerCase()},webview:function(){return"undefined"!=typeof window.Android||"undefined"!=typeof window.iOS},os:{version:function(){return b},android:function(){a&&
...
Modules.module("random",function(){var d=function(b,a){for(var c=a||"ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz_0123456789",d=b||16,f=[],g=0,h=c.length-1;g<d;g++)f.push(c.charAt(Math.round(Math.random()*h)));return f.join("")};return this.publicateAPI("random",{randomString:d,randomId:function(b){return"_"+d(b)},randomNumber:function(b){return parseInt(Math.random().toString().substr(2,b||10))}})});
Modules.load("random").module("utils",function(d){var b=window;return this.publicateAPI("utils",{createGlobalCallback:function(a){for(var c=function(c){b[c]=function(c){a.call(b,c)};return c},e=0;10>e++;){var f="_"+d.random.randomString();if("undefined"==typeof b[f])return c(f)}throw Error("createGlobalCallback: cannot create unique name for callback");},removeGlobalCallback:function(a){try{b[a]=void 0,delete b[a]}catch(c){}},plural:function(a,b,d){var f=[2,0,1,1,1,2];return(d?a+" ":"")+b[4<a%100&&
