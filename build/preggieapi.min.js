/*! PREGGIE_JSAPI | 2015-12-28 */
window.PREGGIEAPI||(window.PREGGIEAPI=function(d){var b={},a={},f={},c=[],e={},g={forced_loading:!1},h=function(b){var a=b||[],c=function(b){for(var c=0;c<a.length;c++)b(a[c],c,a);return a};return{forEach:function(b){return c(function(){b.apply(a,arguments)})},map:function(b){var k=[];c(function(){k.push(b.apply(a,arguments))});return k},filter:function(b){var k=[];c(function(){b.apply(a,arguments)&&k.push(arguments[0])});return k}}},l=function(b,a){c.push([b,a]);m()},m=function(){var a=[];c=h(c).filter(function(c){return 0<
...
PREGGIEAPI.load("device","utils","random").module("api",function(d){var b=function(){};b.prototype.deviceInterface=function(){return this};b.prototype.getCurrentUserId=function(){return"12345"};b.prototype.showToast=function(a){alert(a)};b.prototype.getAuthToken=function(){return"JWT eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwidXNlcl9pZCI6MSwiZW1haWwiOiJhc2RhZEBhc2QucnUiLCJvcmlnX2lhdCI6MTQ1MDc5MTIxMCwiZXhwIjoxNDU5NDMxMjEwfQ.48fBPLzWvucfasE1zczgATLTa1JNPTO7TB4X3vlJ5rI"};b.prototype.upload=
...
b.prototype.makePayment=function(a,b){b=JSON.parse(b);setTimeout(function(){window[b.success]({transaction_id:d.random.randomNumber(),additionalDate:{}})},1E3)};b.prototype.getAppId=function(){return"12345"};var a=function(){this.deviceInterface=function(){return d.device.os.android()?window.Android:d.device.os.ios()?window.iOS:(new b).deviceInterface()}};a.prototype=Object.create(b.prototype);a.prototype.constructor=a;a.prototype.getCurrentUserId=function(){return this.deviceInterface().getCurrentUserId()};
a.prototype.showToast=function(a){this.deviceInterface().showToast(a)};a.prototype.getAuthToken=function(){return this.deviceInterface().getAuthToken()};a.prototype.upload=function(a,b){var e=d.utils.createGlobalCallback(b.preview),g=d.utils.createGlobalCallback(b.progress),h=d.utils.createGlobalCallback(function(a){[e,g,h,l].forEach(function(a){d.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),l=d.utils.createGlobalCallback(function(a){b.error&&b.error(a)});this.deviceInterface().upload(a,
JSON.stringify({preview:e,progress:g,success:h,error:l}))};a.prototype.makePayment=function(a,b){var e=d.utils.createGlobalCallback(function(a){[e,g].forEach(function(a){d.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),g=d.utils.createGlobalCallback(function(a){[e,a].forEach(function(a){d.utils.removeGlobalCallback(a)});b.error&&b.error(a)});this.deviceInterface().makePayment(a,JSON.stringify({success:e,error:g}))};a.prototype.getAppId=function(){return this.deviceInterface().getAppId()};
return this.publicateAPI("API",new a)});
PREGGIEAPI.module("date",function(){var d={absolute:function(){var b=new Date(0);return{day:function(a){return b.setDate(a),this},month:function(a){return b.setMonth(a-1),this},year:function(a){return b.setFullYear(a),this},getTime:function(){return b.getTime()},getUTC:function(){return b.toUTCString()}}},unixtime:function(b){return~~((b||new Date).getTime()/1E3)},toLocaleString:function(b,a,f){b=new Date(1E3*(b||d.unixtime()));var c={year:"numeric",month:"short",day:"numeric"};f=f||{};for(var e in f)f.hasOwnProperty(e)&&
(c[e]=f[e]);return b.toLocaleString(a||"ru",c)},H_M:function(b){var a=new Date(1E3*b);b=10>a.getHours()?"0"+a.getHours():a.getHours();a=10>a.getMinutes()?"0"+a.getMinutes():a.getMinutes();return b+":"+a}};return this.publicateAPI("date",d)});
