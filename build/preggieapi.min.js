...
h(c[1]).filter(function(a){return!b[a]}).length||function(){a.push(function(a,b){return function(){a(b)}}(c[0],p(c[1])))}()});h(a).forEach(function(a){a()})},p=function(a){var c={};h(a).forEach(function(a){var e=c,d=a.split("."),n=d.pop();h(d).forEach(function(a){e=e[a]||(e[a]={})});e[n]=b[a]});return c},r=function(a){return{run:function(b){k(function(a){b.call(window[d],a)},a)},module:function(c,e){k(function(a){b[c]||(b[c]=e.call(window[d],a||void 0));l()},a);f[q(c)]=c}}},m=function(a){for(var b=
document.getElementsByTagName("script"),c=0;c<b.length;c++){var e=b[c].getAttribute("src")||"";if(-1!=e.indexOf(a))return e.substr(0,e.indexOf(a))}return""},q=function(b){for(var e in c)if(0==b.indexOf(e))return c[e];return function(){for(var c=b.length+1;0<--c;){var e=b.substring(0,c);if("undefined"!=typeof a[e])return a[e]+"/"+b.substr(e.length).split(".").join("/")+".js"}return m("/preggieapi.")+"/plugins/"+b.split(".").join("/")+".js"}().replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}).replace(/\/-/g,
"/")};(function(){return function(a){if(!f[a]||g.forced_loading){var b=document.createElement("script");b.setAttribute("src",a+(g.forced_loading?"?"+Math.random():""));b.setAttribute("type","text/javascript");document.getElementsByTagName("head")[0].appendChild(b);f[a]=!0}else l()}})();var s=function(a){var b=function(a){var b=a.match(/^(.*)\((.*)\)$/)||[];return 3==b.length?h(b[2].split("|")).map(function(a){return b[1]+a}):[a]},c=[];h(a).forEach(function(a){h(b(a)).forEach(function(a){c.push(a)})});
return c};a["preggieapi."]=m("/preggieapi.")+"/plugins";return{load:function(){return r(s(arguments))},addPath:function(b,c){a[b]=c},addPackage:function(a,b){c[a]=b},publicateAPI:function(a,b){"undefined"==typeof window[d][a]&&(window[d][a]=b);return b},self:function(a){f[a]=!0},module:function(a,c){b[a]||(b[a]=c.call(window[d],void 0));l()},setup:function(a){for(var b in a)g[b]=a[b];return this},$debugger:{modules:b,paths:a,packages:c,hooks:e}}}("PREGGIEAPI"));
...
a.prototype.constructor=a;a.prototype.getCurrentUserId=function(){return this.deviceInterface().getCurrentUserId()};a.prototype.showToast=function(a){this.deviceInterface().showToast(a)};a.prototype.getAuthToken=function(a){var b=this,f=d.utils.createGlobalCallback(function(g){[f].forEach(function(a){d.utils.removeGlobalCallback(a)});a&&a(b._token=g.token,g)});return a?this.deviceInterface().getAuthToken(JSON.stringify({success:f})):b._token};a.prototype.upload=function(a,b){var f=d.utils.createGlobalCallback(b.preview),
g=d.utils.createGlobalCallback(b.progress),h=d.utils.createGlobalCallback(function(a){[f,g,h,k].forEach(function(a){d.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),k=d.utils.createGlobalCallback(function(a){b.error&&b.error(a)});return this.deviceInterface().upload(a,JSON.stringify({preview:f,progress:g,success:h,error:k}))};a.prototype.cancelUpload=function(a){this.deviceInterface().cancelUpload(a)};a.prototype.makePayment=function(a,b){var f=d.utils.createGlobalCallback(function(a){[f,
g].forEach(function(a){d.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),g=d.utils.createGlobalCallback(function(a){[f,a].forEach(function(a){d.utils.removeGlobalCallback(a)});b.error&&b.error(a)});this.deviceInterface().makePayment(a,JSON.stringify({success:f,error:g}))};a.prototype.getAppId=function(){return this.deviceInterface().getAppId()};return this.publicateAPI("API",new a)});
