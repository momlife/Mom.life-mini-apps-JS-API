...
"/")};(function(){return function(a){if(!f[a]||g.forced_loading){var b=document.createElement("script");b.setAttribute("src",a+(g.forced_loading?"?"+Math.random():""));b.setAttribute("type","text/javascript");document.getElementsByTagName("head")[0].appendChild(b);f[a]=!0}else l()}})();var r=function(a){var b=function(a){var b=a.match(/^(.*)\((.*)\)$/)||[];return 3==b.length?h(b[2].split("|")).map(function(a){return b[1]+a}):[a]},c=[];h(a).forEach(function(a){h(b(a)).forEach(function(a){c.push(a)})});
return c};a["preggieapi."]=m("/preggieapi.")+"/plugins";return{load:function(){return q(r(arguments))},addPath:function(b,c){a[b]=c},addPackage:function(a,b){c[a]=b},publicateAPI:function(a,b){"undefined"==typeof window[d][a]&&(window[d][a]=b);return b},self:function(a){f[a]=!0},module:function(a,c){b[a]||(b[a]=c.call(window[d],void 0));l()},setup:function(a){for(var b in a)g[b]=a[b];return this},$debugger:{modules:b,paths:a,packages:c,hooks:e}}}("PREGGIEAPI"));
...
a.prototype.getAppId=function(){return this.deviceInterface().getAppId()};return this.publicateAPI("API",new a)});
