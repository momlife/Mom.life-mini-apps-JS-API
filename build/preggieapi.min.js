...
g].forEach(function(a){d.utils.removeGlobalCallback(a)});a.error&&a.error(b)});return this.deviceInterface().getAuthToken(JSON.stringify({success:f,error:g}))};a.prototype.upload=function(a,b){var f=d.utils.createGlobalCallback(b.preview),g=d.utils.createGlobalCallback(b.progress),h=d.utils.createGlobalCallback(function(a){[f,g,h,k].forEach(function(a){d.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),k=d.utils.createGlobalCallback(function(a){[f,g,h,k].forEach(function(a){d.utils.removeGlobalCallback(a)});
b.error&&b.error(a)});return this.deviceInterface().upload(a,JSON.stringify({preview:f,progress:g,success:h,error:k}))};a.prototype.cancelUpload=function(a){this.deviceInterface().cancelUpload(a)};a.prototype.makePayment=function(a,b){var f=d.utils.createGlobalCallback(function(a){[f,g].forEach(function(a){d.utils.removeGlobalCallback(a)});b.success&&b.success(a)}),g=d.utils.createGlobalCallback(function(a){[f,g].forEach(function(a){d.utils.removeGlobalCallback(a)});b.error&&b.error(a)});this.deviceInterface().makePayment(a,
